...
// Vier Schnell-Metriken (horizontale Scroll-Zeile, §Schnell-Metrik-Zeile).
const QUICK = [
...
export default function HomePage() {
  ...
  return (
    <div className="pt-safe pb-6">
      ...
      {/* ── Dringlichkeits-Hinweis (nur bei Deadline < 30 Tage) ── */}
      {zeitkritisch && (
      ...
      {/* ── Schnell-Metrik-Zeile (horizontal scrollbar) ── */}
      <section
