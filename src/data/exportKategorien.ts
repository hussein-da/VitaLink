...
export const exportKategorien: ExportKategorie[] = [
  {
    ...
    iconBg: "bg-surface-2",
    zeilen: [
      { id: "pers-stammdaten", label: "Stammdaten", sublabel: "Name, Geburtsdatum, Versicherung", defaultAn: true, kardioRelevant: true },
      { id: "pers-blutgruppe", label: "Blutgruppe", sublabel: "A positiv (A+)", defaultAn: true, kardioRelevant: false },
      { id: "pers-allergien", label: "Allergien & Unverträglichkeiten", sublabel: "Pollen · Penicillin (Verdacht)", defaultAn: true, kardioRelevant: true },
      { id: "pers-familie", label: "Familienanamnese", sublabel: "Hypothyreose, Hypertonie, Diabetes Typ 2", defaultAn: true, kardioRelevant: true },
  ...
  },
  {
    ...
    zeilen: [
      ...
      { id: "labor-blutzucker", label: "Blutzucker & HbA1c", sublabel: "94 mg/dl · 5,4 %", defaultAn: true, kardioRelevant: false },
  ...
  },
  {
    ...
    zeilen: [
      { id: "stw-nuechtern", label: "Nüchternglukose-Trend", sublabel: "Ø 90 mg/dl morgens", defaultAn: true, kardioRelevant: false },
      { id: "stw-peak", label: "Postprandialer Peak-Durchschnitt", sublabel: "Ø 143 mg/dl", defaultAn: true, kardioRelevant: false },
  ...
  },
  {
    ...
    iconBg: "bg-surface-2",
    zeilen: [
      { id: "weit-spo2", label: "SpO₂ Blutsauerstoff", sublabel: "Ø 97 %, letzte Nacht", defaultAn: true, kardioRelevant: true },
      { id: "weit-atem", label: "Atemfrequenz", sublabel: "Ø 16,0/min im Schlaf", defaultAn: true, kardioRelevant: true },
      { id: "weit-hauttemp", label: "Hauttemperatur-Verlauf", sublabel: "14 Nächte, unauffällig", defaultAn: true, kardioRelevant: false },
      { id: "weit-stress", label: "Stress-Score", sublabel: "Ø 39/100 · Donnerstags-Spitze 52", defaultAn: true, kardioRelevant: true },
